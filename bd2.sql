...
-- Started on 2025-04-02 00:22:49
...
--
-- TOC entry 4819 (class 1262 OID 24576)
-- Name: voe-energy; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE "voe-energy" WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'ru-RU';


ALTER DATABASE "voe-energy" OWNER TO postgres;

\connect -reuse-previous=on "dbname='voe-energy'"
...
13	Запчасти для СГУ Derrick (аналоги)	Запчасти для СГУ Derrick (аналоги)	\N
14	Запасные части к илоотделителям Derrick corp	Запасные части к илоотделителям Derrick corp	13
15	Детали Swagger (аналоги)	Аналоговые детали для Swagger	\N
\.
...
21	Swagger деталь	Нефтегазовая деталь (аналог)	15	/uploads/1743537485462.jpg
\.
...
-- Completed on 2025-04-02 00:22:49
